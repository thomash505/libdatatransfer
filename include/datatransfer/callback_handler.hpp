#ifndef DATATRANSFER_CALLBACK_HANDLER_HPP
#define DATATRANSFER_CALLBACK_HANDLER_HPP
...
public:
    template <int N>
    using function_type = void (*)(const typename serialization_policy::template data<N>::type&);
